...
- **Conteúdo sempre atualizado:** Novas perguntas e temas relevantes de acordo com as tendências do universo cibernético.

## Como jogar

1. Acesse o link na descrição do repositório ou abra o arquivo `index.html` em seu navegador.
...
- **Always updated content:** New questions and relevant topics according to cybersecurity trends.

## How to play

1. Access the link in the repository description or open the `index.html` file in your browser.
